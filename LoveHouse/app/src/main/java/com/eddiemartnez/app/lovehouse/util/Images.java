package com.eddiemartnez.app.lovehouse.util;
...
import com.eddiemartnez.app.lovehouse.subclases.RunImage;
                ...
                try{
                    ...
                    if (responseCode == HttpURLConnection.HTTP_OK) { // success
                        ...
                        for(int a=0; a < array.length() ;a++){
                            ...
                            image.url = "https://graph.facebook.com/lovehousecr/picture?height=500&width=500&migration_overrides=%7Boctober_2012%3Atrue%7D="+object.getInt("id");
